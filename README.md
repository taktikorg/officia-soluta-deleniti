# @taktikorg/officia-soluta-deleniti

[![npm version](https://badge.fury.io/js/@taktikorg/officia-soluta-deleniti.svg)](https://badge.fury.io/js/@taktikorg/officia-soluta-deleniti)
[![downloads count](https://img.shields.io/npm/dt/@taktikorg/officia-soluta-deleniti.svg)](https://www.npmjs.com/package/@taktikorg/officia-soluta-deleniti)
[![github-ci](https://github.com/taktikorg/officia-soluta-deleniti/actions/workflows/testing.yml/badge.svg)](https://github.com/taktikorg/officia-soluta-deleniti/actions/workflows/testing.yml)
...
Next, install `@taktikorg/officia-soluta-deleniti`:

```bash
npm install -D @taktikorg/officia-soluta-deleniti
```
